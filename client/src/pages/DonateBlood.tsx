...
export default function DonateBlood() {
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      toast({
        ...
        description:
          "Thank you for becoming a donor. You'll be notified when needed.",
      });
      form.reset();
    } catch (error) {
      toast({
  ...
  const requirements = [
    {
      icon: Calendar,
      text: "Age between 18-65 years old",
      color: "from-red-500 to-red-600",
    },
    { icon: Weight, text: "Weight: +50kg", color: "from-red-600 to-red-700" },
    {
      icon: Droplet,
      text: "At least 8 weeks since last donation",
      color: "from-red-700 to-red-800",
    },
    {
      icon: Heart,
      text: "Be in good health condition",
      ...
      <div className="pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            >
              Join our community of heroes. Your donation can save up to 3
              lives.
            </motion.p>
          </motion.div>
                  ...
                  <div className="space-y-4">
                    {requirements.map((req, index) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`w-12 h-12 bg-gradient-to-br ${req.color} rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform shadow-md`}
                          >
