...
export default function HospitalRequestForm() {
  ...
  const { createRequest, isCreating } = useHospitalBloodRequests();

  const [formData, setFormData] = useState<
    Omit<CreateBloodRequestInput, "hospitalName">
  >({
    bloodType: "",
    unitsNeeded: 1,
    urgencyLevel: "normal",
                ...
                <div className="flex items-center gap-4">
                  <button
                    ...
                    onClick={() =>
                      setFormData({
                        ...formData,
                        unitsNeeded: Math.max(1, formData.unitsNeeded - 1),
                      })
                    }
                  ...
                  <button
                    ...
                    onClick={() =>
                      setFormData({
                        ...formData,
                        unitsNeeded: Math.min(20, formData.unitsNeeded + 1),
                      })
                    }
                    className="w-12 h-12 bg-red-100 text-red-600 rounded-xl font-bold text-xl hover:bg-red-200 transition-colors"
                  >
