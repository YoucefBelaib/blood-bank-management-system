        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#FFEEF0] rounded-3xl p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-[#A30000] text-lg font-semibold">
                  Total Registered Donors
                </h2>
                <p className="text-4xl font-bold text-[#A30000] mt-2">
                  {stats?.totalDonors || 0}
                </p>
              </div>
        ...
        <div className="bg-[#FFEEF0] rounded-3xl p-6 shadow-sm">
          ...
          <div className="flex items-center gap-4 text-gray-600 text-sm mb-4">
            <span className="flex items-center gap-1">
              <span className="w-2 h-2 rounded-full bg-red-600"></span> This
              year
            </span>
            <span className="flex items-center gap-1">
              <span className="w-2 h-2 rounded-full bg-blue-400"></span> Last
              year
            </span>
          </div>
