          ...
          <nav className="flex flex-col gap-8 mt-6">
            ...
            <Link href="/admin">
              <div
                ...
                className={`w-full flex items-center gap-3 px-5 py-3 rounded-full cursor-pointer transition transform duration-300 ease-out ${
                  isActive("/admin")
                    ? "bg-[#A30000] text-white shadow-lg scale-[1.01]"
                    : "text-[#A30000] hover:bg-[#ffdadc] hover:scale-105"
                }`}
              >
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center transition duration-300">
                  ...
                  >
                    ...
                    <path
                      d="M13 13V3a1 1 0 0 1 1-1h.01A10 10 0 0 1 23 13H13z"
            ...
            <div className="flex flex-col gap-4 mt-2">
              <Link href="/admin/donors">
                <div
                  ...
                  className={`group flex items-center gap-3 px-3 py-2 rounded-lg transition transform duration-300 ease-out ${
                    isActive("/admin/donors")
                      ? "text-[#A30000] font-semibold"
                      : "text-[#A30000] hover:translate-x-2 hover:shadow-sm hover:bg-[#ffdadc]"
                  }`}
                >
                  <svg
              ...
              <Link href="/admin/hospitals">
                <div
                  aria-current={
                    isActive("/admin/hospitals") ? "page" : undefined
                  }
                  className={`group flex items-center gap-3 px-3 py-2 rounded-lg transition transform duration-300 ease-out ${
              ...
              <Link href="/admin/requests">
                <div
                  aria-current={
                    isActive("/admin/requests") ? "page" : undefined
                  }
                  className={`group flex items-center gap-3 px-3 py-2 rounded-lg transition transform duration-300 ease-out ${
